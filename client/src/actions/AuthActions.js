...
export function login(username, password) {
    return (dispatch) => {
        ...
        if (anyElementsEmpty({username, password})) {
            dispatch(setErrorMessage(FIELD_MISSING));
                ...
                if (success === true) {
                    ...
                    switch (err.type) {
                        case 'user-doesnt-exist':
                            dispatch(setErrorMessage(USER_NOT_FOUND));
                            return;
                        case 'password-wrong':
                            dispatch(setErrorMessage(WRONG_PASSWORD));
                            return;
                        default:
                            dispatch(setErrorMessage(GENERAL_ERROR));
                            return;
                ...
                if (success) {
                    ...
                    switch (err.type) {
                        case 'username-exists':
                            dispatch(setErrorMessage(USERNAME_TAKEN));
                            return;
                        default:
                            dispatch(setErrorMessage(GENERAL_ERROR));
                            return;
